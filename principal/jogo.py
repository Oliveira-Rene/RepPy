...
class Jogo(object):
    ...
    def CarregaImagens(self):
        ...
        for i in range(1,91):
            ...
            self.spritesheet.append(PhotoImage(r"C:\Users\Andressa Rodrigues\Desktop\RENE\Py\psico_bg.gif"))
    ...
    def novoJogo(self):
        ...
        self.bola = Bola(raio = 30, cor = 'red', pos = (100, 200), vel = (150, 150))
    ...
    def começa(self):
        ...
        Inicia o jogo
        """
        winsound.PlaySound(r"C:\Users\Andressa Rodrigues\Desktop\RENE\Py\som_test.wav", winsound.SND_FILENAME|winsound.SND_ASYNC|winsound.SND_NODEFAULT|winsound.SND_LOOP)
        self.jogar()
